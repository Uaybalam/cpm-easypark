            ...
            <div class="page-wrap">
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        ...
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Desarrollado con <i class="fa fa-heart text-danger"></i> by <a href="#" class="text-dark" target="_blank">Alfonso & Isai</a></span>
                    </div>
                </footer>
